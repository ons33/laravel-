...
@section('content')
    <h4 class="fw-bold py-3 mb-4"> Editer offre</h4>
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('offre.update', ['id' => $OffreEmplois->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                                            ...
                                            <select name="societe_id" class="form-control">
                                                @foreach ($societes as $societe)
                                                    <option value="{{ $societe->id }}"
                                                        {{ $OffreEmplois->societe_id == $societe->id ? 'selected' : '' }}>
                                                        {{ $societe->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="emplacement" class="form-control" placeholder="Emplacement"
                                        value="{{ $OffreEmplois->Emplacement }}" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="apropos" class="form-control" placeholder="Apropos">{{ old('apropos', $OffreEmplois->Apropos) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Editer Offre</button>
                            </div>
                        </div>
                    </form>
                </div>
