            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td>
                                Tunisia: {{ $contractData->date_debut }}
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        ...
                        <tr>
                            <td>The Contract will start on <strong>{{ $contractData->date_debut }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>The employee is hired as a <strong>{{ $contractData->type }}</strong> for a <strong>{{ $contractData->duree }}</strong> position in  and will be responsible for the following tasks, subject to possible changes, with a salary of <strong>{{ $contractData->salaire }} DT</strong>.</td>
                            </tr>
